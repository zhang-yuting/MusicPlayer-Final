...
public class MusicPlay extends Activity implements GestureDetector.OnGestureListener  {
    ...
    private void init() {
        ...
        mLrcProcess.readLrc(this,musicInfosList.get(position).getMusicName()) ;
        //实例化歌词显示界面对象
...
//        mediaPlayer = MediaPlayer.create(this , Uri.parse(musicInfosList.get(position).getData()));
        ...
        try {
            ...
            AssetFileDescriptor fileDescriptor = assetManager.openFd(musicInfosList.get(position).getMusicName());
